...
**Status honesty** a run is *verified* only when Bluevis observed a passing test, build or typecheck after the agent's last edit. Otherwise it is *completed, unverified*.
